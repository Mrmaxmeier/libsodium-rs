...
mod tests {
    ...
    fn test_test_vectors() {
        // RFC 8439 Test Vector for AEAD_CHACHA20_POLY1305
        ensure_init().expect("Failed to initialize libsodium");

        // Key from RFC 8439
        let key_bytes: [u8; KEYBYTES] = [
        ...
        // Nonce from RFC 8439: 32-bit fixed part (07 00 00 00) + IV (40 41 42 43 44 45 46 47)
        let nonce_bytes: [u8; NPUBBYTES] = [
